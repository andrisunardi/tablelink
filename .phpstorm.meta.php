...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/andrisunardi/project/tablelink/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/andrisunardi/project/tablelink/public/storage','logging.default',
...
'livewire.preview-file','dashboard','users.index','users.edit','users.update',
'users.destroy','profile.edit','profile.update','profile.destroy','register','login','password.request','password.email',
...
'dashboard','layouts.app','layouts.guest','layouts.navigation','livewire.home',
'livewire.registration','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'user.edit','user.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
